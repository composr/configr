...
public class SchemaValidationServiceTest extends UnitTest {
  ...
  public void testValidateJSON_WithNullOrMalformed_ShallRaiseException() {
	  ...
	  assertThrows(SchemaValidationException.class, () -> validationService.validateJSON(jsonInvalidSyntax, jsonSchema));
	  ...
	  assertThrows(SchemaValidationException.class, () -> validationService.validateJSON(null, jsonSchema));
	  assertThrows(SchemaValidationException.class, () -> validationService.validateJSON(jsonValid, null));
  }
